...
df = pd.read_csv("IdaPlastLd.csv", sep=",")
...
if st.session_state.printing:
    ...
    fig_comp = px.bar(df_Média, y=aval, x="Compet", barmode='group', color_discrete_map = {"Autoavaliação":"#365DBF", "Gestor":"#98B1EE"})
...
# -------------------------------------------------------------
    ...
    fig_Perg = px.bar(df_filtered2, y="Pergunta", x=aval1, orientation="h", height=500, barmode="group",color_discrete_map={"Autoavaliação":"#365DBF", "Gestor":"#98B1EE"})
